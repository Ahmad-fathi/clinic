  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10">
        ...
        {/* ── Main Row: flex with 3 zones ─────────────────────────────── */}
        {/*
            Left zone  : flex-1  →  Clinic Info + Follow Us
            Center zone: fixed w →  Logo (perfectly centred by flex)
            Right zone : flex-1  →  Quick Links + Patient Resources
        */}
        <div className="flex flex-col md:flex-row items-start gap-10 md:gap-0 pb-16">

          {/* ── LEFT ZONE ─────────────────────────────────────────────── */}
          <div className="flex-1 flex flex-col sm:flex-row items-start gap-10 sm:gap-14">
          ...
          {/* ── CENTER LOGO ── min-w forces the zone to take space; w-full + flex center the logo inside it */}
          <div className="flex flex-col items-center justify-center text-center px-8 md:px-16 flex-shrink-0 min-w-[220px] w-[220px]">
            <div className="w-full flex items-center justify-center">
              <CosmodermLogo size="lg" variant="light" className="scale-110" />
            </div>
          </div>

          {/* ── RIGHT ZONE ────────────────────────────────────────────── */}
          <div className="flex-1 flex flex-col sm:flex-row items-start justify-end gap-10 sm:gap-14 self-start">
