...
// Images
import xerfHeroImg from '../assets/images/optimized/treatment_xerf_1785944840015.webp';
import xerfMachineImg from '../assets/images/optimized/xerf_machine_device_1785956105027.webp';
...
export const XerfServicePage: React.FC<XerfServicePageProps> = ({
  ...
  return (
    <div className="w-full min-h-screen bg-white text-[#24342c] font-avenir selection:bg-[#24342c] selection:text-white pb-16">
      ...
      {/* 4. BEFORE AND AFTER — shared section */}
      <BeforeAfterSection />
      ...
      <section className="w-full bg-white py-16 sm:py-24 px-6 sm:px-12 md:px-16 border-y border-stone-200/60">
        <div className="max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Machine Image — no background container, 8px radius on the image */}
          <div className="flex justify-center md:justify-end">
            <img
              src={xerfMachineImg}
              alt="XERF Cynosure Lutronic RF Device"
              className="max-w-lg w-full h-auto max-h-[390px] sm:max-h-[430px] object-contain rounded-[8px]"
            />
          </div>
